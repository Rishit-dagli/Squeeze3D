...
if [[ "$PYTHON_VERSION" == "3.10" ]] || [[ "$PYTHON_VERSION" == "3.11" ]]; then
    ...
    echo "⚠ WARNING: Python 3.10 or 3.11 required (found: $PYTHON_VERSION)"
fi
...
# remove the . from the cuda version
CUDA_VERSION_STR="${CUDA_VERSION//./}"
...
pip install kaolin==0.17.0 -f https://nvidia-kaolin.s3.us-east-2.amazonaws.com/torch-2.4.1_cu${CUDA_VERSION_STR}.html
