...
if __name__ == "__main__":
    ...
    def parse_args():
        ...
        parser.add_argument(
            "--features_path", default="", help="The path to the features."
        )
        parser.add_argument("--boxes_path", default="", help="The path to the boxes.")
        parser.add_argument(
            "--save_path", default="", help="The path to save the model."
        )
        parser.add_argument(
            "--dataset_split", default="", help="The dataset split to use."
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--train_csv", default="", help="The path to the train csv."
        )
        ...
        parser.add_argument(
            ...
            default=1,
            type=int,
            help="The number of epochs to evaluate.",
        )
        parser.add_argument(
            "--keep_checkpoints",
            default=1,
