...
ax.plot(
    ...
    color="tab:orange",
    linestyle="--",
    label="MAE pretrained encoder (start from scratch)",
)
...
ax.annotate(
    "13\% absolute\nimprovement",
    xy=(labels[3], ap_50[1][3]),
    xytext=(labels[3], ap_50[0][3]),
    ha="center",
    fontsize=10,
    arrowprops=arrow_style,
)
...
ax.set_title(
    r"\textbf{NeRF-MAE} outperforms the SoTA on NeRF 3D Object Detection",
    fontsize=14,
    fontweight="bold",
)
