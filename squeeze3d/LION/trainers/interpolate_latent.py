    ...
    if ode_sample:
        ...
        for i in range(len(dae)):
            ...
            if generate_mode == "subtract":
                ...
                logger.info(
                    "linear interpolate latent between left most and right most"
                )
                ...
                for k in range(1, noise.shape[0]):
                    noise[k] = noise[
                        0
                    ]  # for local latent, use the same one for all samples
