...
class AdamsBashforthMoulton(FixedGridODESolver):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(AdamsBashforthMoulton, self).__init__(
            func, y0, rtol=rtol, atol=rtol, **kwargs
        )
    ...
    def _step_func(self, func, t0, dt, t1, y0):
        ...
        if order < _MIN_ORDER - 1:
            ...
            return (
                rk4_alt_step_func(
                    func, t0, dt, t1, y0, f0=self.prev_f[0], perturb=self.perturb
                ),
                f0,
            )
        else:
            ...
            if self.implicit:
                ...
                for _ in range(self.max_iters):
                    ...
                    f = func(
                        t1,
                        y0 + dy,
                        perturb=Perturb.PREV if self.perturb else Perturb.NONE,
                    )
