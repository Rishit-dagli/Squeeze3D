...
from squeeze3d.miche.michelangelo.models.modules import checkpoint
from squeeze3d.miche.michelangelo.models.modules.distributions import (
    DiagonalGaussianDistribution,
)
from squeeze3d.miche.michelangelo.models.modules.embedder import FourierEmbedder
from squeeze3d.miche.michelangelo.models.modules.transformer_blocks import (
...
class ShapeAsLatentPerceiver(ShapeAsLatentModule):
    ...
    def forward(
        ...
        latents, center_pos, posterior = self.encode(
...
class AlignedShapeLatentPerceiver(ShapeAsLatentPerceiver):
    ...
    def forward(
        ...
        shape_embed, kl_embed, posterior = self.encode(
            pc, feats, sample_posterior=sample_posterior
        )
