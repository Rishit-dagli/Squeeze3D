...
class CLIPAlignedShapeAsLatentModule(AlignedShapeAsLatentModule):
    ...
    def __init__(
        self, *, shape_model, clip_model_version: str = "openai/clip-vit-large-patch14"
    ):
        ...
        self.shape_projection = nn.Parameter(
            torch.empty(self.shape_model.width, self.shape_model.width)
        )
    ...
    def forward(self, surface, image, text):
        ...
        # shape embedding
        shape_embed, shape_latents = self.encode_shape_embed(
