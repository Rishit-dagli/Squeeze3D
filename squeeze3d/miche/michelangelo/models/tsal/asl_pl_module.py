...
from squeeze3d.miche.michelangelo.models.tsal.inference_utils import extract_geometry
...
class AlignedShapeAsLatentPLModule(nn.Module):
    ...
    def to_shape_latents(self, latents):
        ...
        shape_zq, posterior = self.model.shape_model.encode_kl_embed(
            latents, sample_posterior=False
        )
    ...
    def training_step(
        ...
        embed_outputs, shape_logits, posteriors = self(
        ...
        self.log_dict(
            ...
            prog_bar=True,
            logger=True,
            batch_size=shape_logits.shape[0],
            sync_dist=False,
            rank_zero_only=True,
        )
