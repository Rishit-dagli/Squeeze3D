...
from squeeze3d.miche.michelangelo.models.modules.diffusion_transformer import (
    UNetDiffusionTransformer,
)
from squeeze3d.miche.michelangelo.models.modules.transformer_blocks import MLP
    ...
    def __init__(
        ...
        *,
        ...
        self.time_embed = Timesteps(
            width, flip_sin_to_cos=flip_sin_to_cos, downscale_freq_shift=0
        )
        self.time_proj = MLP(
